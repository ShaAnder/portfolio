...
/*
	Sheet (slide-over panel) styling notes
	--------------------------------------
	- Powered by Base UI Dialog primitives.
	- We lean on data attributes (`data-[side=...]`, `data-starting-style`, `data-ending-style`) to
	  drive transitions without writing custom CSS.
	- All colors come from semantic tokens (popover/background/foreground).
*/
...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
	return (
		<SheetPrimitive.Backdrop
			...
			className={cn(
				// Light dim + optional blur. Kept subtle to maintain a modern look.
	...
	return (
		<SheetPortal>
			...
			<SheetPrimitive.Popup
				...
				className={cn(
					/*
						The big class string is doing a few jobs at once:
						- Positioning: fixed + edge pinning depending on `side`.
						- Surface styling: popover tokens + shadow.
						- Motion: opacity + translate transitions keyed off Base UI data attributes.
						- Responsiveness: max width on larger screens.
					*/
				...
				{showCloseButton && (
					<SheetPrimitive.Close
						...
						render={
							<Button
								variant="ghost"
								// Anchor close affordance to top-right, consistent with common sheet patterns.
